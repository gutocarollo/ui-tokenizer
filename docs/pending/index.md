...
**6 itens abertos** — 2 esperam decisao do dono, 4 sao trabalho de agente. Resolver um item e **apagar o arquivo** `docs/pending/<id>.md` e regenerar este indice; o git guarda o historico.
...
| [ ] | [o artefato não nomeia mais QUAL scanner falhou — só que a corrida não é exaustiva](scanner-falhado-perdeu-o-ponteiro-no-artefato.md) | media | nada; degrada o diagnóstico de uma corrida não-exaustiva | [`.claude/skills/tokenize-design-system/scripts/lib/axis-discovery.mjs:705`](../../.claude/skills/tokenize-design-system/scripts/lib/axis-discovery.mjs) |
